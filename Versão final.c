...

{
	...
	while (logado == 1) {
        ...
        printf(" Digite o número para a funções desejada: ");
        ...
        switch (funcao) {
            ...
            case 1:
                ...
                printf(" Confirmar Usuario e senha?\n\n");
                ...
                if (strcmp(senhadigitada, senha) != 0 || strcmp(logindigitado, login) != 0) {
                    ...
                    while (1) {
                        ...
                        if (sn == 's') {
                            ...
                            printf("\n \033[1;96m##### ARCADE STORE #####\n\n");

                            printf("        CADASTRO\033[m\n\n");
...
while (continua == 's' || continua == 'S')
	...
	printf("==================================================\n");
		...
		switch (menu){
			...
			printf("\n\033[35mDigite o numero do jogo para mais informações ou '0' para voltar ao menu: \033[0m");
...
if (tipoP == 'C' || tipoP == 'c') {
    ...
    while (tentativas < 3) {
        ...
        printf("Digite o \033[1m Numero do seu Cartão (16 digito): \033[0m");
        ...
        if (strlen(info) == 16 && strlen(validade) == 5 && validade[2] == '/') {
            ...
            printf("\033[1;31m\nNumero do cartão ou data invalido! Tentativa %d de 3.\n\033[0m", tentativas + 1);
    ...
    if (valido == 0) {
        ...
        printf("\nNumero de tentativas excedido. Cancelando pagamento voltando ao menu...\n");
...
if (tipoP == 'D' || tipoP == 'd') {
    ...
    while (tentativas < 3) {
        ...
        printf("Digite o \033[1m Numero do seu cartão (16 Digitos): \033[0m");
    ...
    if (valido == 0) {
        ...
        printf("\nNúmero de tentativas excedido. Cancelando pagamento voltando ao menu...\n");
		...
		continue;
...

				{
					...
					printf("\033[1;31m\Opção invalida!\n\033[0m");
...

{
	...
	printf("\033[1;32m?\033[0m \033[33mMinecraft\033[0m\t\t\t\033[1;37m[PRONTO PARA JOGAR]\033[0m\n");
...

{
	...
	printf("\033[1;32m?\033[0m \033[33mGTA V\033[0m\t\t\t\t\033[1;37m[PRONTO PARA JOGAR]\033[0m\n");
...

{
	...
	printf("\033[1;32m?\033[0m \033[33mAssassin's Creed Mirage\033[0m\t\033[1;37m[PRONTO PARA JOGAR]\033[0m\n");
		...
		case 4:
			...
			printf("Muito Obrigado Por visitar a Arcade Store esperamos que volte\003");
